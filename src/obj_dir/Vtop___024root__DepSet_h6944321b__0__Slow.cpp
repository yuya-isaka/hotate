...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    VL_RAND_RESET_W(96, vlSelf->top__DOT__Core__DOT__rf);
    ...
    vlSelf->top__DOT__Seven__DOT__tmp = VL_RAND_RESET_I(32);
    vlSelf->__Vfunc_top__DOT__Seven__DOT__decode__4__Vfuncout = VL_RAND_RESET_I(7);
    vlSelf->__Vfunc_top__DOT__Seven__DOT__decode__4__binary = VL_RAND_RESET_I(4);
    vlSelf->__Vfunc_top__DOT__Seven__DOT__decode__5__Vfuncout = VL_RAND_RESET_I(7);
    vlSelf->__Vfunc_top__DOT__Seven__DOT__decode__5__binary = VL_RAND_RESET_I(4);
    vlSelf->__Vfunc_top__DOT__Seven__DOT__decode__6__Vfuncout = VL_RAND_RESET_I(7);
    vlSelf->__Vfunc_top__DOT__Seven__DOT__decode__6__binary = VL_RAND_RESET_I(4);
    vlSelf->__Vfunc_top__DOT__Seven__DOT__decode__7__Vfuncout = VL_RAND_RESET_I(7);
    vlSelf->__Vfunc_top__DOT__Seven__DOT__decode__7__binary = VL_RAND_RESET_I(4);
    VL_RAND_RESET_W(96, vlSelf->__Vchglast__TOP__top__DOT__Core__DOT__rf);
}
